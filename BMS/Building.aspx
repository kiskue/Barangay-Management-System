<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Building.aspx.cs" Inherits="BMS.Building" %>
                                     ...
                                     <div class="col-lg-4 col-lg-offset-4">
                                        ...
                                        <div class="col-sm-4 col-md-3 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <select runat="server" id="Intention" name="Place" required="Please fill up"  class="form-control">
                                        ...
                                        <option value="Excavate">Excavate</option>
                                          ...
                                          <div class="col-sm-4 col-md-3 col-xs-12">
                                            <div class="form-group">
                                                <label>Age:</label>
                                                <asp:Textbox runat="server" type="text" class="form-control" placeholder="Age" id="Age" />
                                            </div>
                                        </div>
                                             <div class="col-lg-4 col-lg-offset-4">
                                            <div class="form-group">
                                                <label>Build What:</label>
                                                <asp:Textbox runat="server" type="text" class="form-control" placeholder="Build What?" id="Build" />
                                            </div>
                                        </div>
                                      <div class="col-sm-4 col-md-3 col-xs-12">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:Textbox runat="server" class="form-control" type="text" value="Building Permit" id="indigency" hidden="true"  />
                                            </div>
                                        </div>
                                         <div class="col-sm-4 col-md-3 col-xs-12">
                                            <div class="form-group">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuildingPermit.aspx.cs" Inherits="BMS.BuildingPermit" %>
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="card">
                                    <div class="card-header bg-danger">
                                        <h6 class="card-title text-uppercase text-white">BARANGAY BUILDING PERMITS</h6>
                                    </div>
    ...
    <ContentTemplate >
        <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" class="table table-condensed " 
            ...
            <Columns >
                ...
                <asp:BoundField DataField="Number" HeaderText="Number" />
                 <asp:BoundField DataField="Intention" HeaderText="Intention" />
        ...
        <table align="center">
            ...
            <tr>
             ...
             <tr>
                <td>Number</td>
                <td> <asp:Textbox runat="server" type="text" class="form-control" placeholder="Number"  id="Number" /></td>
            </tr>
             <tr>
                <td>Intention</td>
                <td> <asp:Textbox runat="server" type="text" class="form-control" placeholder="Intention"  id="Intention" /></td>
            </tr>
            <tr>
                <td>Age</td>
                <td><asp:Textbox runat="server" type="text" class="form-control" placeholder="Age" id="Age" /></td>
            </tr>
              <tr>
                <td>Build</td>
                <td><asp:Textbox runat="server" type="text" class="form-control" placeholder="Build" id="Build" /></td>
            </tr>
            ...
            <tr>
                ...
                <td> <asp:Textbox runat="server" class="form-control" type="text" value="Building Permit" id="indigency" hidden="true"  /></td>
            </tr>
            <tr>

...
namespace BMS
{
    public partial class Building : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand commandToCheckEmail = new SqlCommand("select Email from BuildingPermit where Email='" + Email.Text + "'", con);
                ...
                else
                {
                    ...
                    cmd.Parameters.AddWithValue("@Intention", Intention.Value);
                    cmd.Parameters.AddWithValue("@Age", Age.Text);
                    cmd.Parameters.AddWithValue("@Build", Build.Text);
                    ...
                    if (k != 0)
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "alert",
                            "swal('success','Please enter the correct data','success');window.location.href='" + "Building.aspx" + "';", true);
        ...
        private void BindGridView()
        {
            ...
            {
                SqlCommand comm = new SqlCommand("select * from BuildingPermit where Email='" + Session["FirstName"].ToString() + "'", con);

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BarangayIndigency1.aspx.cs" Inherits="BMS.BarangayIndigency1" %>
    ...
    <ContentTemplate >
        ...
        <table align="center">
            ...
            <tr>
              ...
              <tr>
                <td>Address</td>
                <td> <asp:Textbox runat="server" type="text" class="form-control" placeholder="Address"  id="Address" /></td>
            </tr>
              <tr>
                <td>Number</td>
             ...
             <tr>
                <td>Sex</td>
                <td><asp:Textbox runat="server" type="text" class="form-control" placeholder="Sex" id="Sex" /></td>
            </tr>
              <tr>
                <td>Year</td>
            ...
            <tr>
                ...
                <td> <asp:Textbox runat="server" class="form-control" type="text" value="Barangay Indigency" id="indigency" hidden="true"  /></td>
            </tr>
            <tr>

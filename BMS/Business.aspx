<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Business.aspx.cs" Inherits="BMS.Business" %>
...
<body id="page-top">
                            ...
                            <div class="container py-4">
                                ...
                                <div class="card">
                                    <div class="card-header bg-primary">
                                        <h6 class="card-title text-uppercase text-white">BARANGAY BUSINESS PERMIT</h6>
                                    </div>
                                     ...
                                     <div class="col-lg-4 col-lg-offset-4">
                                        ...
                                        <div class="col-sm-4 col-md-3 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <select runat="server" id="NBusiness" name="Place" required="Please fill up"  class="form-control">
                                        <option value="Sari-Sari Store">Sari-Sari Store</option>
                                        <option value="Street Food/Cart">Street Food/Cart</option>
                                        <option value="Market Vendor">Market Vendor</option>
                                        <option value="Small Panaderya">Small Panaderya</option>
                                        <option value="Small Karinderya">Small Karinderya</option>
                                    </select>
                                          </div>
                                        </div>
                                          <div class="col-sm-4 col-md-3 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <asp:Textbox runat="server" type="text" class="form-control" placeholder="Business Location" id="BLocation" />
                                            </div>
                                        </div>
                                           <div class="col-lg-4 col-lg-offset-4">
                                            <div class="form-group">
                                        ...
                                        <option value="Closed">Closed</option>
                                           ...
                                           <div class="col-sm-4 col-md-3 col-xs-12">
                                            <div class="form-group">
                                                <label>Permit:</label>
                                                <select runat="server" id="Permit" name="Place" required="Please fill up"  class="form-control">
                                      ...
                                      <div class="col-sm-4 col-md-3 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:Textbox runat="server" class="form-control" type="text" value="Business Permit" id="indigency" hidden="true"  />
                                            </div>
                                        </div>
                                         <div class="col-sm-4 col-md-3 col-xs-12">
                                            <div class="form-group">
 ...
 <div class="container py-4">
                                    ...
                                    <div class="card">
                                        <div class="card-header bg-primary">
                                            <h6 class="card-title text-uppercase text-white">Requested Permits</h6>

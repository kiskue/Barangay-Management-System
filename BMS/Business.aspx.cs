...
namespace BMS
{
    public partial class Business : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand commandToCheckEmail = new SqlCommand("select Email from BusinessPermit where Email='" + Email.Text + "'", con);
                ...
                else
                {
                    ...
                    cmd.Parameters.AddWithValue("@NatureBusiness", NBusiness.Value);
                    cmd.Parameters.AddWithValue("@Permit", Permit.Value);
                    cmd.Parameters.AddWithValue("@Address", Address.Text);
                    cmd.Parameters.AddWithValue("@BLocation", BLocation.Text);
                    ...
                    if (k != 0)
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "alert",
                            "swal('success','Please enter the correct data','success');window.location.href='" + "Business.aspx" + "';", true);
        ...
        private void BindGridView()
        {
            ...
            {
                SqlCommand comm = new SqlCommand("select * from BusinessPermit where Email='" + Session["FirstName"].ToString() + "'", con);

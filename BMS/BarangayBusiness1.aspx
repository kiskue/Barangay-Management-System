<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BarangayBusiness1.aspx.cs" Inherits="BMS.BarangayBusiness1" %>
...
<body id="page-top" >
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="BarangayCertiifcate1.aspx">Barangay Clearance</a>
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="card">
                                    <div class="card-header bg-danger">
                                        <h6 class="card-title text-uppercase text-white">BARANGAY BUSINESS PERMITS</h6>
                                    </div>
    ...
    <ContentTemplate >
        <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" class="table table-condensed " 
            ...
            <Columns >
                ...
                <asp:BoundField DataField="Number" HeaderText="Number" />
                 <asp:BoundField DataField="NatureBusiness" HeaderText="Nature of Business" />
                 <asp:BoundField DataField="PermitNo" HeaderText="Permit Number" />
        ...
        <table align="center">
            ...
            <tr>
                <td>Name</td>
                <td> <asp:Textbox runat="server" type="text" class="form-control" placeholder="FullName"  id="Name" /></td>
            </tr>
            <tr>
                <td>Email</td>
                <td>
            ...
            <tr>
             ...
             <tr>
                <td>Nature of Business</td>
                <td> <asp:Textbox runat="server" type="text" class="form-control" placeholder="Nature Of Business"  id="NatureBusiness" /></td>
            </tr>
            <tr>
                <td>Permit Number</td>
                <td><asp:Textbox runat="server" type="text" class="form-control" placeholder="Permit Number" id="PermitNo" /></td>
            </tr>
              <tr>
                <td>Status</td>
                <td><asp:Textbox runat="server" type="text" class="form-control" placeholder="Status" id="Status" /></td>
            </tr>
            ...
            <tr>
                <td>Valid Until</td>
                <td><asp:Textbox runat="server" type="date" class="form-control" placeholder="Status" id="ValidUntil" /></td>
            </tr>
            <tr>
                <td>Ammount</td>
                <td><asp:Textbox runat="server" type="text" class="form-control" placeholder="Status" id="Amount" /></td>
            </tr>
            <tr>
                
                <td> <asp:Textbox runat="server" class="form-control" type="text" value="Business Permit" id="indigency" hidden="true"  /></td>
            </tr>
            <tr>
                ...
                <td colspan="2" align="center">
                    ...
                    <asp:Button ID="btnSave" Text="Update" runat="server" OnClick="Save" CssClass="btn btn-success" />
                     <asp:Button Text="Done" ID="Button1" CssClass="btn btn-primary " runat="server"  onclick="btndone" OnClientClick="return confirm('Are you sure you want to Mark Claimed this request?')"/>
                        ...
                        <div class="form-row justify-content-center" style="padding:15px 15px 15px 15px; margin-top:20px" id="dvReport">
                         <CR:CrystalReportViewer ID="CrystalReportViewer2" runat="server" AutoDataBind="True" GroupTreeImagesFolderUrl="" Height="1202px" ReportSourceID="CrystalReportSource1" ToolbarImagesFolderUrl="" ToolPanelWidth="200px" Width="1104px" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" />

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserProfile.aspx.cs" Inherits="BMS.UserProfile" %>
       ...
       <form id="form1" runat="server">
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/UserDash/Index">
                                      ...
                                      <div class="col-lg-4 col-lg-offset-4">
                                            <div class="form-group">
                                                <label>FirstName:</label>
                                                 <asp:Textbox runat="server" type="text" class="form-control" placeholder="FirstName"  id="FirstName" />
